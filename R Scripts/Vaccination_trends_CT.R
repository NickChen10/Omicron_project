...
cdc <- read.csv(paste0(path,"/Data/COVID-19_Vaccination_Trends_in_the_United_States_National_and_Jurisdictional.csv"))
...
ggplot(data = cdc, aes(x=Date, y=`Percent Coverage`,color=`Vaccination Status`,fill=`Vaccination Status`)) + 
  ...
  scale_color_manual(values = c("#b3c3c3","#7e9999","#587b7c","#3e6667","#2c5759"))+
  scale_fill_manual(values = c("#b3c3c3","#7e9999","#587b7c","#3e6667","#2c5759"))
  #scale_alpha_manual(values = c(0.3,0.3,0.3,0.3,0.3))
